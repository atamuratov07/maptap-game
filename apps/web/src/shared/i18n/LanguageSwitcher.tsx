...
export function LanguageSwitcher({
	...
	return (
		<label
			className={`inline-flex w-fit max-w-full flex-none items-center gap-2 rounded-full border px-3 py-2 text-sm font-black shadow-sm ${
				isDark
		...
		>
			...
			<Globe2 aria-hidden='true' size={16} strokeWidth={2.4} />
			<select
